...
class VipTag{
	public function getViptagsData($bossid){
		return Boss_InterfaceFactory::createInstanceBossOneDAL()->getViptagsData($bossid);
	}
...
$onetag=array();
$arr=$viptag->getViptagsData($bossid);
							...
							<div class="tab-pane  active" id="portlet_tab3">
											...
											<form action="./interface/setviptag.php" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input type="text" placeholder="必填" id="tagname" name="tagname" class="m-wrap span5" >
													</div>
												</div>
												<hr>
