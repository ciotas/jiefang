...
require_once (_ROOT.'takeoutwechat/IBLL/IWechatBLL.php');//接口定义
require_once (_ROOT.'takeoutwechat/Factory/DataFactory.php');//引用下层数据
class WechatBLL implements IWechatBLL{
	...
	public function getOpendTime($shopid){
	    return Wechat_DataFactory::createInstanceWechatDAL()->getOpendTime($shopid);
	}
}
?>
