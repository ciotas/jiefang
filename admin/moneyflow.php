...
class MoneyFlow{
	public function getMoneyFlowData($datearr){
		return Admin_InterfaceFactory::createInstanceAdminOneDAL()->getMoneyFlowData($datearr);
	}
}
$moenyflow=new MoneyFlow();
$title="流水走势";
$menu="data";
$clicktag="moneyflow";
$i=0;
...
$data=$moenyflow->getMoneyFlowData($datearr);
?>
					...
					<div class="span12">
						<div class="portlet box green">
							<div class="portlet-title">
								<div class="caption"><i class="icon-table"></i>流水走势图</div>
								<div class="tools">
									
								</div>
							</div>
							<div class="portlet-body flip-scroll">
							<form action="./moneyflow.php" method="post">
