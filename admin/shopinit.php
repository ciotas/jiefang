								...
								<table class="table table-hover">
									<thead>
										<tr>
											...
											<th class="number">年费</th>
											<th class="number">精选</th>
											<th class="number">贝贝</th>
											<th class="number">微信点餐</th>
										</tr>
									</thead>
									<tbody>
									<?php foreach ($arr as $key=>$val){?>
										<tr>
											...
											<td class="number"><p contenteditable="true" onblur="setTopclearmoney('<?php echo $val['shopid'];?>','yearfee','<?php echo $key;?>')" id="yearfee<?php echo $key;?>"><?php echo $val['yearfee'];?></p></td>
											<td class="number">
											<div class="info-toggle-button">
												<input type="checkbox" class="toggle"  id="hot<?php echo $key;?>" <?php if($val['hot']=="1"){echo "checked";}?> onchange="changeSwitchStatus(<?php echo $key;?>,'hot','<?php echo $val['shopid'];?>')" />
											</div>
											</td>
											<td class="number">
											<div class="info-toggle-button">
											...
											<td class="number">
												<div class="info-toggle-button">
												<input type="checkbox" class="toggle"  id="wechatstatus<?php echo $key;?>" <?php if($val['wechatstatus']=="1"){echo "checked";}?> onchange="changeSwitchStatus(<?php echo $key;?>,'wechatstatus','<?php echo $val['shopid'];?>')" />
											</div>
											</td>
										</tr>
										<?php }?>
