	...
	<div class="header navbar navbar-inverse navbar-fixed-top">
		...
		<div class="navbar-inner">
			...
			<div class="container-fluid">
				...
				<a class="brand" href="<?php echo $admin_url;?>index.php">
					<img src="<?php echo $admin_url;?>media/image/logo.png" alt="" />
				</a>
				...
				<img src="<?php echo $admin_url;?>media/image/menu-toggler.png" alt="" />
 ...
 -->
					...
					<li class="dropdown user">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="<?php echo $admin_url;?>index.php"><i class="icon-user"></i> 我的主页</a></li>

					<!-- 		<li><a href="inbox.html"><i class="icon-envelope"></i> 我的信息(6)</a></li> -->

							<li class="divider"></li>

							<li><a href="<?php echo $admin_url;?>extra_lock.php"><i class="icon-lock"></i>锁屏</a></li>

							<li><a href="<?php echo $admin_url;?>logout.php"><i class="icon-key"></i> 注销</a></li>
