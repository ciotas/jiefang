...
class BillNumFlow{
	public function getBillnumFlowData($datearr){
		return Admin_InterfaceFactory::createInstanceAdminOneDAL()->getBillnumFlowData($datearr);	
	}
}
$billnumflow=new BillNumFlow();
$title="下单数走势";
$menu="data";
$clicktag="billnumflow";
$i=0;
...
$data=$billnumflow->getBillnumFlowData($datearr);
?>
					...
					<div class="span12">
						<div class="portlet box green">
							<div class="portlet-title">
								<div class="caption"><i class="icon-table"></i>下单数走势图</div>
								<div class="tools">
									
								</div>
							</div>
							<div class="portlet-body flip-scroll">
							<form action="./billnumflow.php" method="post">
