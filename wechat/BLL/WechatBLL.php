...
require_once (_ROOT.'wechat/IBLL/IWechatBLL.php');//接口定义
...
class WechatBLL implements IWechatBLL{
	...
	{
	    return Wechat_DataFactory::createInstanceWechatDAL()->getTabNum($tabid);
	}
    /**
     * {@inheritDoc}
     * @see IWechatBLL::getByCusnum()
     */
    public function getByCusnum($shopid)
    {
        // TODO Auto-generated method stub
        return Wechat_DataFactory::createInstanceWechatDAL()->getByCusnum($shopid);
    }
    public function getPostRequest($url='', $data){
        return Wechat_DataFactory::createInstanceWechatDAL()->getPostRequest($url, $data);
    }
