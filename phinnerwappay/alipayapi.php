...
//必填，不能修改
//服务器异步通知页面路径
$notify_url = ROOTURL."phinnerwappay/notify_url.php";
//需http://格式的完整路径，不能加?id=123这类自定义参数

//页面跳转同步通知页面路径
$return_url = ROOTURL."phinnerwappay/payreturn.php";
...
// file_put_contents("/var/www/html/log.txt", $html_text);
$path=_ROOT."phinnerwappay/paydata/".$payid."/";
if(!file_exists($path)){
    $cmd1="mkdir -p ".$path;
    shell_exec($cmd1);
...
// echo $html_text;
?>
<iframe frameborder=0 width="100%" height="600"  style="margin:0;padding:0" MARGINWIDTH=0 MARGINHEIGHT=0 scrolling=no src="<?php echo ROOTURL;?>phinnerwappay/paydata/<?php echo $payid;?>/submit.html"></iframe>
</body>
</html>