...
// 							    echo "验证失败";
						...
						<!--  	<a class="btn red big btn-block"  target="_blank" href="<?php echo ROOTURL;?>phwechat/interface/menu.php?shopid=<?php echo $shopid;?>&uid=<?php echo $uid;?>&tabid=<?php echo $tabid;?>&type=inner&paystatus=paid"><—返回首页</a>-->
								<!--end tab-pane-->
						</div>
...
function lunch(){
	window.location.href="<?php echo ROOTURL;?>phwechat/interface/menu.php?shopid=<?php echo $shopid;?>&uid=<?php echo $uid;?>&tabid=<?php echo $tabid;?>&type=inner&paystatus=paid";
}
</script>
					</div>
