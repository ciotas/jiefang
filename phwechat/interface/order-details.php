...
if(isset($_GET['billid'])){
	...
	$onebillshopinfo=$order_details->getOneBillShopinfo("billshopinfo", $billid);
// 	print_r($billarr);
}
                    ...
                    <div class="details">
                        <div class="details-top">
                         ...
                         <!--    <p class="watch-number"><span>流水号：<?php echo $billarr['orderno'];?></span><font></font></p> -->
                          <!--     <p><span>流水号：</span><?php echo $billarr['billnum'];?></p>--> 
                            <p><span>收货地址：</span><?php echo $onebillshopinfo['prov'].$onebillshopinfo['city'].$onebillshopinfo['dist'].$onebillshopinfo['road'];?></p> 
                            <p><span>店名：</span><?php echo $onebillshopinfo['shopname'];?></p>
                            <p><span>联系人：</span><?php echo $onebillshopinfo['contact'];?></p>
                            <p><span>电话：</span><?php echo $onebillshopinfo['phone'];?></p>
							<p><span>配送时间：</span><?php echo $onebillshopinfo['picktime'];?></p>
							 <p><span>备注：</span><?php echo $onebillshopinfo['orderrequest'];?></p>
...
<!--                                         <th width="20%">状态</th> -->
                ...
                <div class="godesh immediately">
                    <a href="./menu.php?shopid=<?php echo $billarr['shopid'];?>&uid=<?php echo $billarr['uid'];?>&tabid=<?php echo $billarr['tabid'];?>&paystatus=<?php echo $paystatus;?>"><span><i></i>返回</span></a>
                </div>
            </div>
        </div>
    </div>
