...
<body style="background:#fff;">
	...
	<div class="businesses">
		...
		<div id="datePlugin"><div id="dateshadow" style="display: none;"></div><div id="datePage" class="page" style="display: none; height: 380px; top: 60px;"><section><div id="datetitle"><h1>请选择日期</h1></div><div id="datemark"><a id="markyear"></a><a id="markmonth"></a><a id="markday"></a></div><div id="timemark"><a id="markhour"></a><a id="markminut"></a><a id="marksecond"></a></div><div id="datescroll"><div id="yearwrapper" style="overflow: hidden; position: absolute; bottom: 200px;"><ul style="transition-property: -webkit-transform; transform-origin: 0px 0px 0px; transform: translate3d(0px, -640px, 0px) scale(1);"><li>&nbsp;</li><li>2000年</li><li>2001年</li><li>2002年</li><li>2003年</li><li>2004年</li><li>2005年</li><li>2006年</li><li>2007年</li><li>2008年</li><li>2009年</li><li>2010年</li><li>2011年</li><li>2012年</li><li>2013年</li><li>2014年</li><li>2015年</li><li>2016年</li><li>2017年</li><li>2018年</li><li>2019年</li><li>2020年</li><li>&nbsp;</li></ul></div><div id="monthwrapper" style="overflow: hidden; position: absolute; bottom: 200px;"><ul style="transition-property: -webkit-transform; transform-origin: 0px 0px 0px; transform: translate3d(0px, -160px, 0px) scale(1);"><li>&nbsp;</li><li>01月</li><li>02月</li><li>03月</li><li>04月</li><li>05月</li><li>06月</li><li>07月</li><li>08月</li><li>09月</li><li>10月</li><li>11月</li><li>12月</li><li>&nbsp;</li></ul></div><div id="daywrapper" style="overflow: hidden; position: absolute; bottom: 200px;"><ul style="transition-property: -webkit-transform; transform-origin: 0px 0px 0px; transform: translate3d(0px, -80px, 0px) scale(1);"><li>&nbsp;</li><li>1日</li><li>2日</li><li>3日</li><li>4日</li><li>5日</li><li>6日</li><li>7日</li><li>8日</li><li>9日</li><li>10日</li><li>11日</li><li>12日</li><li>13日</li><li>14日</li><li>15日</li><li>16日</li><li>17日</li><li>18日</li><li>19日</li><li>20日</li><li>21日</li><li>22日</li><li>23日</li><li>24日</li><li>25日</li><li>26日</li><li>27日</li><li>28日</li><li>29日</li><li>30日</li><li>31日</li><li>&nbsp;</li></ul></div></div><div id="datescroll_datetime" style="display: block;"><div id="Hourwrapper" style="overflow: hidden;"><ul style="transition-property: -webkit-transform; transform-origin: 0px 0px 0px; transform: translate3d(0px, -443px, 0px) scale(1);"><li>&nbsp;</li><li>1时</li><li>2时</li><li>3时</li><li>4时</li><li>5时</li><li>6时</li><li>7时</li><li>8时</li><li>9时</li><li>10时</li><li>11时</li><li>24</li><li>&nbsp;</li></ul></div><div id="Minutewrapper" style="overflow: hidden;"><ul style="transition-property: -webkit-transform; transform-origin: 0px 0px 0px; transform: translate3d(0px, -2120px, 0px) scale(1);"><li>&nbsp;</li><li>00分</li><li>01分</li><li>02分</li><li>03分</li><li>04分</li><li>05分</li><li>06分</li><li>07分</li><li>08分</li><li>09分</li><li>10分</li><li>11分</li><li>12分</li><li>13分</li><li>14分</li><li>15分</li><li>16分</li><li>17分</li><li>18分</li><li>19分</li><li>20分</li><li>21分</li><li>22分</li><li>23分</li><li>24分</li><li>25分</li><li>26分</li><li>27分</li><li>28分</li><li>29分</li><li>30分</li><li>31分</li><li>32分</li><li>33分</li><li>34分</li><li>35分</li><li>36分</li><li>37分</li><li>38分</li><li>39分</li><li>40分</li><li>41分</li><li>42分</li><li>43分</li><li>44分</li><li>45分</li><li>46分</li><li>47分</li><li>48分</li><li>49分</li><li>50分</li><li>51分</li><li>52分</li><li>53分</li><li>54分</li><li>55分</li><li>56分</li><li>57分</li><li>58分</li><li>59分</li><li>&nbsp;</li></ul></div><div id="Secondwrapper" style="overflow: hidden;"><ul style="transition-property: -webkit-transform; transform-origin: 0px 0px 0px; transform: translate3d(0px, -40px, 0px) scale(1);"><li>&nbsp;</li><li>上午</li><li>下午</li><li>&nbsp;</li></ul></div></div></section><footer id="dateFooter"><div id="setcancle"><ul><li id="dateconfirm">确定</li><li id="datecancle">取消</li></ul></div></footer></div></div>
		...
		<div class="conf_list flex_box">
			<span>店&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名</span>
			<div class="conf_main flex_a">
				<input type="text" class="conf_input"  id="shopname"  value="<?php if(!empty($oneshopinfo)){echo $oneshopinfo['shopname'];}?>"/>
			</div>
		</div>	
		...
		<div class="conf_list flex_box">
			<span>联&nbsp;&nbsp;&nbsp;系&nbsp;&nbsp;&nbsp;人</span>
			<div class="conf_main flex_a">
				<input type="text"  id="contact"  value="<?php if(!empty($oneshopinfo)){echo $oneshopinfo['contact'];}?>"/>
			</div>
		</div>	
		...
		<div class="conf_list flex_box">
			<span>配&nbsp;送&nbsp;时&nbsp;间</span>
			<div class="conf_main flex_a">
				<input type="text" id="picktime" value="<?php echo date("Y-m-d",time()+2*3600)?>" readonly />
			</div>
		</div>	
		<div class="conf_list flex_box">
			<span>备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注</span>
	...
	<li><span><input type="radio" name="radio" id="directpay" value="directpay" /><label for="alipay">到付</label></span></li>
...
*/
	...
	$('#mark').on('click',function(){
    	...
    	$('.canvasAlert').show();
         ...
         loadingObj.show();   
    	 $.ajax({
				url:"<?php echo ROOTURL?>printbill/interface/prephdownbill.php",
				type:"POST",
				data:data,
