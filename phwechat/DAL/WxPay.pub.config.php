...
class WxPayConf_pub
{
	...
	//=======【证书路径设置】=====================================
	//证书路径,注意应该填写绝对路径
	const SSLCERT_PATH = '/var/www/html/phwechat/DAL/cacert/apiclient_cert.pem';
	const SSLKEY_PATH = '/var/www/html/phwechat/DAL/cacert/apiclient_key.pem';
	
	//=======【异步通知url设置】===================================
	//异步通知url，商户根据实际开发过程设定
	const NOTIFY_URL = 'http://shop.meijiemall.com/phwechat/interface/notify_url.php';
