...
$decreasenum=$typecalc->getDecreasenum($shopid);
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="typecalc.php">类别统计</a></li>
						</ul>
								...
								<table class="table-bordered table-striped table-condensed flip-content" style="text-align:center;">
									...
									<?php foreach ($typearr as $key=>$val){
										...
										<tr>
											...
											<td class="numeric"><?php echo $decreasenum*$val['soldnum'];?></td>
											<td class="numeric"><?php echo $decreasenum*$val['soldmoney']?></td>
