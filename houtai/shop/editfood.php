...
//-->
	...
	<div class="alert alert-error">
					...
					<strong>红色字体部分为必填项，否则会无法正常点餐。</strong>
				</div>
				<!-- BEGIN PAGE CONTENT-->
							...
							<div class="portlet-body form">
								<div class="tabbable portlet-tabs">
										...
										<div class="tab-pane active" id="portlet_tab1">
											<!-- BEGIN FORM-->
											<form action="./interface/addonefood.php" method="post" class="form-horizontal">
...
<!-- 															<option value="0">---请选择类别---</option> -->
												...
												<div class="form-actions">
													...
													<button type="button" class="btn"  onclick="window.location.href='./foodmanage.php?typeno=<?php echo $typeno;?>' ">取消</button>
