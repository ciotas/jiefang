...
// 			 		window.location.href='http://test.meijiemall.com/houtai/shop/interface/docusvippay.php?billid=562354575bc109ad5c8b456b&uid=560ffb637cc10967058b4578&shopid=554ad9615bc109d8518b45d2&shouldpay=708&accountbalance=88198&carddiscount=90&discounmoney=53&deposit=1&nickname=lindy';
				 	url='http://shop.meijiemall.com/houtai/shop/interface/docusvippay.php?billid='+billid1+'&uid='+uid1+'&shopid='+shopid1+'&shouldpay='+shouldpay1+'&accountbalance='+data1['accountbalance']+'&carddiscount='+data1['carddiscount']+'&discounmoney='+discounmoney+'&deposit='+deposit1+'&nickname='+nickname1;
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								<div class="caption"><i class="icon-coffee"></i>明细</div>
							</div>
							<div class="portlet-body">
								<table class="table table-bordered table-hover">
									...
									?>
										...
										<tr><td colspan="6" ><button class="btn yellow btn-block">支付宝支付 <i class="m-icon-swapright m-icon-white"></i></button></td></tr>
									...
									<!-- <tr><td colspan="6" ><button class="btn red btn-block" onclick="window.location.href='http://test.meijiemall.com/houtai/shop/interface/docusvippay.php?billid=562354575bc109ad5c8b456b&uid=560ffb637cc10967058b4578&shopid=554ad9615bc109d8518b45d2&shouldpay=708&accountbalance=88198&carddiscount=90&discounmoney=53&deposit=1&nickname=lindy'">会员卡支付 <i class="m-icon-swapright m-icon-white"></i></button></td></tr> --> 
