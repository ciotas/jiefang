...
$shopid=$handle->getShopidByOpenid($openid);
...
function changeSwitchStatus(op){
	...
	var url="../interface/shopswitch_wechat.php"
	url=url+"?op="+op
	url=url+"&status="+status
	url=url+"&shopid=<?php echo $shopid;?>"
							...
							<div class="portlet-body">
								<div class="tabbable portlet-tabs">
										...
										<div class="tab-pane active" id="portlet_tab">
											...
											<div class="control-group">
											<label class="control-label">营业截止时间点</label>
												<div class="controls">
			...
			<!-- BEGIN PAGE CONTENT-->          
				<div class="row-fluid">
					<div class="span8">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-credit-card"></i>营业时间段（外卖版本有效） </div>
								<div class="tools">
								...
								<table class="table table-hover">
									...
									<?php $i = 1; foreach ($timearr as $key=>$val){
										...
										<tr>
											...
											<a href="../interface/delonetimeslot.php?id=<?php echo strval($val['_id']);?>&shopid=<?php echo $shopid;?>&openid=<?php echo $openid;?>" onclick="return confirm('确定要删除？');" class="btn mini red"><i class="icon-trash"></i> </a>
											</td>
										</tr>
										<?php 
										$i++;
								...
								<table class="table table-hover">
									...
									<?php $i = 1; foreach ($discountarr as $key=>$val){
										...
										<tr>
											...
											<a href="../interface/delDiscount.php?id=<?php echo strval($val['_id']);?>&shopid=<?php echo $shopid;?>&openid=<?php echo $openid;?>" onclick="return confirm('确定要删除？');" class="btn mini red"><i class="icon-trash"></i> </a>
											</td>
										</tr>
										<?php 
										$i++;
								...
								<table class="table table-hover">
									...
									<?php $i = 1; foreach ($farearr as $key=>$val){
										...
										<tr>
											...
											<a href="../interface/delFare.php?id=<?php echo strval($val['_id']);?>&shopid=<?php echo $shopid;?>&openid=<?php echo $openid;?>" onclick="return confirm('确定要删除？');" class="btn mini red"><i class="icon-trash"></i> </a>
											</td>
										</tr>
										<?php 
										$i++;
					...
					<div id="static2" class="modal hide fade" tabindex="-1" data-backdrop="static1" data-keyboard="false">
						<div class="modal-body">
							...
							<div class="tab-pane  active" id="portlet_tab">
											...
											<h4></h4>
											<form action="../interface/editFare.php?act=add" method="post">
											<input type="hidden" name="shopid" value="<?php echo $shopid;?>">
											<input type="hidden" name="openid" value="<?php echo $openid;?>" >
												<div class="control-group">
					...
					<div id="static1" class="modal hide fade" tabindex="-1" data-backdrop="static2" data-keyboard="false">
						<div class="modal-body">
							...
							<div class="tab-pane  active" id="portlet_tab">
											...
											<h4></h4>
											<form action="../interface/editDiscount.php" method="post">
												<input type="hidden" name="shopid" value="<?php echo $shopid;?>">
												<input type="hidden" name="openid" value="<?php echo $openid;?>" >
												<div class="control-group">
