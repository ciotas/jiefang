							...
							<div class="portlet-body flip-scroll">
								<table class="table-bordered table-striped table-condensed flip-content" style="text-align:center;">
										...
										<tr>
											...
											<th class="numeric">支付宝交易号</th>
											<th class="numeric">客户</th>
											<th class="numeric">消费台号</th>
									...
									<?php foreach ($arr as $key=>$val){?>
										<tr>
											...
											<td class="numeric"><?php echo $val['buyer'];?></td>
											...
											<?php }?>
											<?php if($paytype=="alipay"){?>
											<td class="numeric"><?php echo $val['buyemail'];?></td>
											<?php }?>
											<td class="numeric"><?php echo $val['paymoney'];?></td>											
											<td class="numeric"><?php echo date("Y-m-d H:i:s",$val['downtime']);?></td>
											<td class="numeric"><?php echo date("Y-m-d H:i:s",$val['buytime']);?></td>
										</tr>
										<?php }?>
									</tbody>
