...
/**************************请求参数**************************/
        ...
        //必填，不能修改
        //服务器异步通知页面路径
        $notify_url = $base_url."wappay/buygoods_notifyurl.php";
        //需http://格式的完整路径，不能加?id=123这类自定义参数

        //页面跳转同步通知页面路径
        $return_url = $base_url."wappay/buygoods_returnurl.php";
        //需http://格式的完整路径，不能加?id=123这类自定义参数，不能写成http://localhost/

        //商户订单号
        $out_trade_no = time().mt_rand(100, 999).mt_rand(111, 888);
        //商户网站订单系统中唯一订单号，必填
       ...
       $subject = $_POST['goodsname'];
        ...
        //必填
        //订单描述
        $body =json_encode( array("goodsid"=>$goodsid,"goodsname"=>$subject, "goodsnum"=>$goodsnum,"soldunit"=>$soldunit, "from"=>$from,"via"=>$via,"value"=>$value));
        //必填
