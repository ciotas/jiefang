					...
					<div class="span12">
						...
						<div class="tabbable tabbable-custom tabbable-full-width">
							...
							if($verify_result) {//验证成功
							    ...
							    if(empty($billid)){$billid="";}
							   $arr= $payreturn->getPayRecordData($trade_no, $billid);
// 								echo "验证成功<br />";
...
// 							    echo "验证失败";
							...
							?>
									...
									<ul class="span10" style="list-style-type: none;">
										...
										<li><h4>订单号：<?php if(!empty($arr)){echo $arr['out_trade_no'];};?></h4></li>
										...
										<li><h4>买单时间：<?php if(!empty($arr)){echo date("Y-m-d H:i:s",$arr['buytime']);}?></h4> </li>
									</ul>
