...
class CombineTab{
	...
	public function combineTwoTab($tabid1, $tabid2){
		QuDian_InterfaceFactory::createInstanceMonitorTwoDAL()->combineTwoTab($tabid1, $tabid2);
	}
}
...
if(isset($_POST['tab1'])){
	$tabid1=$_POST['tab1'];
	$tabid2=$_POST['tab2'];
	$combinetab->combineTwoTab($tabid1, $tabid2);
	echo '<script>alert("并台成功！")</script>';
}
$arr=$combinetab->getZoneTabByShopid($shopid);
?>
				...
				<div class="alert alert-error">
									<strong>温馨提示：只有两个都在开台且未买过单的桌台，才可以实现并台</strong>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>并台</div>
							...
							<div class="portlet-body form">
								...
								<form action="<?php echo $_SERVER['PHP_SELF'];?>" class="form-horizontal" method="post">
									...
									<div class="control-group">
										...
										<label class="control-label">合并到</label>
									...
									<div class="form-actions">
										...
										<button type="submit" class="btn blue">并台</button>
