...
$allowinbalance=$header->getAllowinbalanceValue($shopid);
?>
<!-- BEGIN BODY -->
...
<!-- 
 ...
 -->
					...
					<li class="dropdown user">
						...
						<span class="username"><?php if(!empty($_SESSION['shopid'])){echo $_SESSION['shopname'].'('.$_SESSION['servername'].')';}?></span>
						...
						<ul class="dropdown-menu">
							...
							<li><a href="<?php echo $root_url;?>boss/index.php"><i class="icon-user"></i> 总店主页</a></li>
