...
$vipcardarr=$sendvip->getChargeVipCard($shopid, "storeflag");
...
<script src="./media/js/vip.js"></script>
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="vippay.php">会员卡支付</a></li>
								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										<div class="tab-pane active" id="portlet_tab1">
											<!-- BEGIN FORM-->
											<form action="./interface/dovippay.php" class="form-horizontal" method="post">
												...
												<div class="control-group error">
													...
													<div class="controls">
														<select class="large m-wrap" tabindex="1" name="cardid"  id="cardid" onblur="checkvipaytype(this.value)">
											...
											<div class="control-group error">
													...
													<div class="controls">
														<input type="tel" placeholder="必填，数字" name="vippaymoney" id="vippaymoney" onblur="checkvippaymoney(this.value)" class="m-wrap large" />
														<span class="help-inline" id="vippaymoneytip"></span>
													</div>
												</div>
	...
	if(isset($_GET['status'])){
		...
		switch ($status){
			...
			case "vippaymoney":echo "<script>alert('消费金额不能为空！')</script>";break;
			case "phone_unreg":echo "<script>alert('此手机号未注册开饭啦app！')</script>";break;
			case "full":echo "<script>alert('抱歉，卡内余额不足！')</script>";break;
		}
	}
	?>